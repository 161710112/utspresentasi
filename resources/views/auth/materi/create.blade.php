			  ...
			  <div class="panel-body">
			  	<form action="{{ route('materis.store') }}" method="post" >
			  		...
			  		<div class="form-group {{ $errors->has('tandu') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="tandu" class="form-control"  required>
			  			@if ($errors->has('tandu'))
                            <span class="help-block">
			  		...
			  		<div class="form-group {{ $errors->has('doras') ? ' has-error' : '' }}">
			  			<label class="control-label">Donor Darh Siswa</label>	
			  			<input type="text" name="doras" class="form-control"  required>
			  			@if ($errors->has('doras'))
                            <span class="help-block">
			  		...
			  		<div class="form-group {{ $errors->has('asican') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="asican" class="form-control"  required>
