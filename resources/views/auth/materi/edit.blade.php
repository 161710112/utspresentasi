			  	...
			  	<form action="{{ route('materis.update',$materis->id) }}" method="post" >
        			...
        			{{ csrf_field() }}
			  		<div class="form-group {{ $errors->has('pp') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="pp" class="form-control" value="{{ $materis->pp }}"  required>
			  			@if ($errors->has('pp'))
			  		...
			  		<div class="form-group {{ $errors->has('pk') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="pk" class="form-control" value="{{ $materis->pk }}"  required>
			  			@if ($errors->has('pk'))
                            <span class="help-block">
			  		...
			  		<div class="form-group {{ $errors->has('tandu') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="tandu" class="form-control" value="{{ $materis->tandu }}"  required>
			  			@if ($errors->has('tandu'))
                            <span class="help-block">
			  		...
			  		<div class="form-group {{ $errors->has('doras') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="doras" class="form-control" value="{{ $materis->doras }}"  required>
			  			@if ($errors->has('doras'))
                            <span class="help-block">
			  		...
			  		<div class="form-group {{ $errors->has('asican') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="asican" class="form-control" value="{{ $materis->asican }}"  
			  			required>
