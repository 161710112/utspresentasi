			  	...
			  	<form action="{{ route('sejarahs.update',$sejarahs->id) }}" method="post" >
        			...
        			{{ csrf_field() }}
			  		...
			  		<div class="form-group {{ $errors->has('ttl') ? ' has-error' : '' }}">
			  			...
			  			<input type="date" name="ttl" class="form-control" value="{{ $sejarahs->ttl }}"  required>
			  			@if ($errors->has('ttl'))
                            <span class="help-block">
			  		...
			  		<div class="form-group {{ $errors->has('sejarah') ? ' has-error' : '' }}">
			  			...
			  			<input type="textarea" name="sejarah" class="form-control" value="{{ $sejarahs->sejarah }}"  required>
