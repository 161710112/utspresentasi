			  ...
			  <div class="panel-body">
        			<div class="form-group">
			  		...
			  		<div class="form-group">
			  			...
			  			<input type="date" name="ttl" class="form-control" value="{{ $sejarahs->ttl }}"  readonly>
			  		</div>

			  		<div class="form-group">
			  			<label class="control-label">Warga Negara</label>	
			  			<input type="textarea" name="warga_negara" class="form-control" value="{{ $sejarahs->warga_negara }}"  readonly>
			  		</div>
